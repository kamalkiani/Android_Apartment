...
views.get("rightmenu").vw.setWidth((int)((70d / 100 * width)));
views.get("rightmenu").vw.setHeight((int)((100d / 100 * height)));
views.get("toolslist").vw.setLeft((int)(0d));
views.get("toolslist").vw.setTop((int)((10d / 100 * height)));
views.get("toolslist").vw.setWidth((int)((70d / 100 * width)));
...
views.get("webview1").vw.setHeight((int)((80d / 100 * height)));
views.get("btmimg").vw.setLeft((int)(0d));
views.get("btmimg").vw.setTop((int)((90d / 100 * height)));
views.get("btmimg").vw.setWidth((int)((100d / 100 * width)));
views.get("btmimg").vw.setHeight((int)((10d / 100 * height)));
